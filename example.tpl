        ...
        <tr>
          ...
          <div class="main">
            <p style="text-align: center;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%; margin-bottom: 30px;">
              <img src="https://user-images.githubusercontent.com/194400/49531010-48dad180-f8b1-11e8-8d89-1e61320e1d82.png" width="200" alt="Reeduka Logo" style="-ms-interpolation-mode: bicubic;border: 0;height: auto;line-height: 100%;outline: none;text-decoration: none;">
            </p>

            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer placerat varius interdum : <strong>{{.To}}</strong></p>
            
            <p>Quisque blandit feugiat leo. Mauris lacus mauris, eleifend id cursus at, hendrerit non nulla. Nam quis lorem risus :</p>

            <strong style="font-size: 24px;">{{.Secret}}</strong>
            <br>
            <br>
            Cordialement, L’équipe ezMailer
            <br><br>
            <hr style="border: 2px solid #EAEEF3; border-bottom: 0; margin: 20px 0;">
            <p style="text-align: center;color: #A9B3BC;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;">
              Cette adresse e-mail ne peut pas recevoir de réponses.
              <br> ezMailer, 123 Rue Bidon, 69000 Lyon, France
            </p>
          </div>
          </td>
        </tr>
